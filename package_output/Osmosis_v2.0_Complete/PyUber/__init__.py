...
PyUber is co-written by Daniel Lenski (Intel PTD LYA), 2013-2015
and Victor Uriarte (Intel FSM PDE), 2013-

* Docs, examples, updates: http://github.intel.com/fabnet/PyUber
...
I've based PyUber mostly on the Uber example code in Perl, JSL, C#-script,
...
PyUber accesses Uber via the .NET API (as used in the C#Script examples)
