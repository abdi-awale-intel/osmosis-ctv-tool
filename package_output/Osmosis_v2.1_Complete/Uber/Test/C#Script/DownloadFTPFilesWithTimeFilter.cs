...
public class UberTest
{
    static public void Main(string[] args)
    {
        ...
        try
        {
            ...
            var timefilter = "All";  // Can be anything like Last 10 mins , Last 10 days or any other valid LA2 type time filter syntax
            var table = helper.DownloadFilesUsingFTP(fileList, timefilter , outputDirectory);
            table.DisplayTable();
